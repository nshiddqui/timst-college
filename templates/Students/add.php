        ...
        <div class="card">
            <div class="card-body bootstrap-select-1">
                <div class="table-responsive">
                    <?= $this->Form->create($student, ['type' => 'file', 'id' => 'student-from']); ?>
                    <div tabindex="1">
                        ...
                        <section data-step="0" class="row">
                            ...
                            <div class="col-md-4">
                                <?= $this->Form->control('photo', ['class' => 'form-control', 'type' => 'file', 'accept' => 'image/*']) ?>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <?= $this->Form->control('document_front', ['class' => 'form-control', 'type' => 'file', 'accept' => 'image/*']) ?>
                            </div>
                            <div class="col-md-4">
                                <?= $this->Form->control('document_back', ['class' => 'form-control', 'type' => 'file', 'accept' => 'image/*']) ?>
                            </div>
                            <div class="col-md-4">
                                ...
                                <table class="table table mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <?= $this->Form->control('qualification_detail.secondary_documents', ['class' => 'form-control', 'type' => 'file', 'label' => false]) ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Sr. Secondary</td>
                                            ...
                                            <td>
                                                <?= $this->Form->control('qualification_detail.sr_secondary_documents', ['class' => 'form-control', 'type' => 'file', 'label' => false]) ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Graduation</td>
                                            ...
                                            <td>
                                                <?= $this->Form->control('qualification_detail.graduation_documents', ['class' => 'form-control', 'type' => 'file', 'label' => false]) ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                <?= $this->Form->control('qualification_detail.post_graduation_documents', ['class' => 'form-control', 'type' => 'file', 'label' => false]) ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Other</td>
                                            ...
                                            <td>
                                                <?= $this->Form->control('qualification_detail.other_documents', ['class' => 'form-control', 'type' => 'file', 'label' => false]) ?>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
